...
select DISTINCT g.course_name,g.major, f.username,c.f_name,c.m_name,c.l_name,e.subject_code,c.home_address,c.gender,c.birthdate
...
inner join user f on f.user_id=d.user_id

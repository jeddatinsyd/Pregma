...
class UserProfile extends StatefulWidget{
  String student_id;
  UserProfile({Key key,this.student_id}) : super(key:key);
        ...
        Uri.encodeFull(
            ...
            setState(() 
            {
              if(data2 != null) {
                ...
                current_address = data2[0]['current_address'];
      ...
      Column(
        children: <Widget>[
          ...
          ListTile(
              leading: Icon(Icons.verified_user),
              title: Text("Course"),
              subtitle: Text(course_name,style:TextStyle(
                          fontSize: 20.0,color: Colors.black
                    ),  ),
            ),
            ...
            ListTile(
             ...
             ListTile(
              ...
              subtitle: Text(home_address,style:TextStyle(
                          fontSize: 20.0,color: Colors.black
                    ),  ),
            ),
